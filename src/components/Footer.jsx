            ...
            <div className="footer-grid grid">
                ...
                <nav className="social-links" aria-label="social links">
                    <ul className="footer-social-links-list flex">
                        <li><img src="../src/assets/icons/icon-facebook.svg" alt="facebook icon" className="footer-social-icon" /></li>
                        <li><img src="../src/assets/icons/icon-youtube.svg" alt="youtube icon" className="footer-social-icon" /></li>
                        <li><img src="../src/assets/icons/icon-instagram.svg" alt="instagram icon" className="footer-social-icon" /></li>
                        <li><img src="../src/assets/icons/icon-pinterest.svg" alt="pinterest icon" className="footer-social-icon" /></li>
                    </ul>
                </nav>
            </div>
        </div>
